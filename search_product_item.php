...
<body>
    <header class="header">
                <div class="header-item">
                    ...
                    <div class="header-right-item">
                        ...
                        <div class="user-item">
                            <i class="user-item-logo fa-regular fa-user"></i>
                            <div class="user__register-login">
                                <ul class="modal-list">
                                    <li class="modal-item">
                                        <a href="login.php" class="modal-item-login">ĐĂNG NHẬP</a>
                                    </li>
                                    <li class="modal-item">
                                        <a href="register.php" class="modal-item-register">ĐĂNG KÝ</a>
                                    </li>
                                    <li class="modal-item">
    ...
    <div class="app__container">
        <div class="show__product" style="margin-top:100px;">
            <div class="name-sort__all-product" style="margin:  12px 300px;">
                <h1 class="name-of__all-product" style="    padding: 0 300px;">
                    KẾT QUẢ TÌM KIẾM               
                </h1>
